export function errorMapTranslatedUtil(error: unknown): Error {
  ...
  const cognitoErrorMessages: Record<string, string> = {
    ...
    'Cannot reset password for the user as there is no registered/verified email or phone_number':
      'Verifica tu correo para cambiar tu contraseña.',
    'Attempt limit exceeded, please try after some time.':
      'Se excedió el límite de intentos, por favor intente después de un tiempo.',
    'Username/client id combination not found.': 'Verifica que tu correo exista.',
    'Invalid verification code provided, please try again.':
      'Verifica que tu codigo sea el correcto.',
  };
